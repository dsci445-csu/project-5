...
- In the table, we can observe that the regression models at day 28 performed better than the models of day 3.
- Some of the best Lasso models were constants.
- If we compare the results obtained with the mean and standard deviation of tenderness at the different aging periods, the results are not accurate.
