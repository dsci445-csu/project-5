...
dataset <- read.csv("/data/accounts/fa24/amandabartels/DSCI445/group project/apartments_for_rent_classified_10K.csv", sep = ";")
...
# Change 'bedrooms' and 'bathrooms' from string to int
# and 'has_photo' from string to binary
dataset <- dataset %>%
  mutate(
    bedrooms = as.numeric(bedrooms),
    bathrooms = as.numeric(bathrooms),
    has_photo = ifelse(has_photo == "Yes", 1, 0)
  )
