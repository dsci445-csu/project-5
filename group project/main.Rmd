...
Logisitic regression had higher accuracy when predicting on higher or lower than average apartment prices based on the predictors provided in the dataset but little improvements can be made to the model past this. The linear pregression model can be improved upon and is probably the easest to interpret but has a larger residual error mean.
# References
