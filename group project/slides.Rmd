---
title: "Apartment Rental Rates Across the United States"
author: "Amanda Bartels, Mohamad Habibniaykoochesfahani, Isabella Kukor, Casey Martin"
output: pdf_document
date: "2024-12-02"
geometry: "landscape"
---
...
- Categorical data counts explored potential levels with 1 count. i.e. only 1 apartment was pay type “Weekly”, 1 apartment was both “Monthly and Weekly” while 9998 apartments were “Monthly” 

- This led to removing unnecessary variables in the dataset such as address and time. 

- All NA data points were removed.  

- Several amenities were included in the data set. Pivoted these wider and attached dummy variables to extract information on specific amenities. 

- Data set was split for training and testing data to be the same for each portion of the project 
...
A linear regression model with all remaining predictors was used to predict the price of apartments. Price is a continuous variable, so it makes it an easy candidate for a linear model. It is easily interpretable as any predictor would essentially showcase a dollar amount associated with the addition of square footage, amenities, bathrooms etc. We were interested more so in how accurate our model would be and whether other models we learned in class would outperform simpler models.   
...
The regression model with the best RMSE is the decision tree model, which is suprising given its simpleness compared to random forests and boosted models, especially considering that XG boost handles inbalanced datasets better.
